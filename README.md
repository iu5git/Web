...
Добавить поле input для ограничения количества записей, отображаемых на странице
...
Добавление страницы просмотра для таблицы бронирований (корзина товаров, бронирования) и кнопки бронирования услуги. Из корзины товар можно удалить. Подключение к нужным сервисам/методам бекенда. Должна быть доступна админская панель бекенда.
