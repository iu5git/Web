...
Добавление **менеджера состояний** (`redux` или через хуки `useReducer`, `useContext`) для кеширования полученных по API данных товаров/услуг и их использования в компонентах, а также для хранения состояния корзины (пока без самих POST запросов)
