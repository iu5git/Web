...
Обязательно наличие 5 или более статусов `заявок`: черновик, удалён, сформирован, завершён, отклонён. Названия таблиц и их полей должны соответствовать предметной области. Удаляет и формирует создатель заявки, отклоняет и завершает модератор.
...
- Заявки - список, одна запись (поля `заявки` + ее `услуги`), изменение, статусы создателя, статусы модератора, удаление
