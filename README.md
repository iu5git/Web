...
* документацию (UML диаграмму из `StarUML`/`figma` + 1 модуль ТЗ, 2 модуль - РПЗ)
...
- **Контрольные вопросы**: любые вопросы по реализации интерфейса `модератора`, Agile, DevOps, UML
