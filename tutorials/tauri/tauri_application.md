# Создание Tauri приложения с нуля

В данном разделе рассматривается создание нового Tauri 2.0 приложения с нуля.

[Настройка Tauri для существующего React проекта](README.md)
