...
2. Расчеты для археологов. `Услуги` - удельные княжества Древней Руси, `заявка` - расчет населения для указанных княжеств по обнаруженной археологами площади населенных пунктов
...
5. Логистика доставок грузовиками. `Услуги` - модели грузовиков с грузоподьемностью, `заявка` - детали доставки с описанием, адресами, количеством необходимых машин и их грузами, расчет стоимости
...
5. Отклонение в пузырьковой камере для разных частиц. `Услуги` - исследуемые частицы (позитрон, альфа- и бета-частицы, и тд), `заявка` - расчет отклонения выбранных частиц с их энергиями для указанных параметров исследования (расстояние, параметры поля и тд)